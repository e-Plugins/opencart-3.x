<?php
// Heading
$_['heading_title'] = 'DigiWallet Afterpay';

// Text
$_['text_payment'] = 'Betaling';
$_['text_success'] = 'Gelukt: de DigiWallet instellingen zijn gewijzigd!';
$_['text_edit'] = 'Bewerk DigiWallet ' . $_['heading_title'];
$_['text_afterpay'] = '<a href="https://www.digiwallet.nl/signup?p_actiecode=YM3R2A" target="_blank"><img src="view/image/payment/afterpay.png" alt="Afterpay via DigiWallet" title="Afterpay via DigiWallet" style="border: none;" /></a>';
