<?php
// Heading
$_['heading_title'] = 'DigiWallet Paypal';

// Text
$_['text_payment'] = 'Payment';
$_['text_success'] = 'Success: You have modified DigiWallet account details!';
$_['text_edit'] = 'Edit ' . $_['heading_title'];
$_['text_paypal'] = '<a href="https://www.digiwallet.nl/signup?p_actiecode=YM3R2A" target="_blank"><img src="view/image/payment/paypal.png" alt="Paypal by DigiWallet" title="Paypal by DigiWallet" style="border: none;" /></a>';
$_['text_sale'] = 'Sale';
